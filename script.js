...
function displayAllSearchedMovie(value) {
  ...
  div.innerHTML = value.Response === "False" ? `<h1>${"Movie not found"}</h1>` :
    `<div class="card" style="width: 18rem;">
    <img src="${value.Poster}" class="card-img-top" alt="${value.Title}">
    <div class="card-body">
      <h5 class="card-title">${value.Title}</h5>
      <button class="btn btn-primary">Add to favarite</button>
      ...
      <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="staticBackdropLabel" style="color: black;">${value.Title}</h1>
          ...
          <div class="modal-body">
            ...
            <div class="modal-small-headings">
              <ul id="movie-points">
                <li id="category-type" class="font-color">${value.Type}</li>
                <li id="rated" class="font-color">${value.Rated}</li>
                <li id="country">${value.Country}</li>
                <li id="genre">${value.Genre}</li>
                <li id="award">${value.Awards}</li>
              </ul>
            </div>
            ...
            <div class="actors">${value.Actors}</div>
  ...
  if (favorite) {
    favorite.map((obj) => {
      ...
      <div class="card-body">
        ...
        <button class="btn btn-danger" data-imdbid="${obj.imdbID}">Remove from favorite</button>
